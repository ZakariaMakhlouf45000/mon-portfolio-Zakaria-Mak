...
export default function Footer() {
    return (
        <footer className="py-8 text-center font-mono text-xs bg-[var(--bg-secondary)] text-[var(--text-secondary)]">
            <div className="mb-4 flex justify-center gap-6">
                ...
                <a
                    ...
                    className="text-[var(--text-secondary)] hover:text-[var(--accent)] hover:scale-110 transition-all duration-300"
                    aria-label="GitHub"
                >
            ...
            <p>Conçu & Développé par Zakaria Makhlouf</p>
            <p className="mt-2 opacity-70 text-[10px]">
                Propulsé par Next.js, Tailwind CSS & GitHub Pages
            </p>
        </footer>
    );
}
